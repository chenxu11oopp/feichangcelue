<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\www\feichangcelue2/application/index\view\ucenter\mobile\home.html";i:1528856223;s:66:"E:\www\feichangcelue2/application/index\view\public\PublicNav.html";i:1528856223;}*/ ?>
<!doctype html>
		...
		<div class="bg" style="min-height: 100%;margin-bottom: -50px;">
			...
			<div class="person_content mui-content" style="min-height: 100%;">
		        ...
		        <li class="mui-table-view-cell mui-text-center li_last">
		            <a href="<?php echo url('index/index/logout'); ?>" style="color: #F5191D;" id="loginbtn">
		                 退出登录
		            </a>
		        </li>
