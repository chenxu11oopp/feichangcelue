<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\www\feichangcelue/application/index\view\ucenter\mobile\payment.html";i:1528441654;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="UTF-8">
...
<!--个人中心-充值-->
	<body class="payment_body">
		<header class="mui-bar mui-bar-nav">
		    <a class="red_back mui-action-back mui-icon mui-icon-left-nav mui-pull-left" href="javascript:history.back(-1)"></a>
