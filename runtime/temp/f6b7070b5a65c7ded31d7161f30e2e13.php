<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\www\feichangcelue/application/index\view\ucenter\mobile\re_tip.html";i:1528440388;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="UTF-8">
		...
		<div class="mui-content">
		    ...
		    <section class="sec1 bg_fff mui-clearfix">
		    	...
		    	<div class="text mui-pull-left mui-col-xs-9">
		    		<p>支付账号：<span class="copy" id="copyText">2509137766@qq.com</span></p>
		    		<p> 尚牛在心贸有限公司</p>
			...
			<p class="mui-text-center font12 re_p3">08：45-17:00（30分钟内到账） 17:00以后（次日09:30到账）</br> 如急需到账，请电话 <a href="tel:<?php echo $phone; ?>" target="_blank">联系客服</a></p>
