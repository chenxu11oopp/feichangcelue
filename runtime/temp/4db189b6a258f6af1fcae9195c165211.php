<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\www\feichangcelue/application/index\view\ucenter\mobile\add_bankcard.html";i:1528681766;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body class="addbank_body bankcard_body">
		...
		<div class="mui-content">
		   <p class="ml-tip">选择银行账户</p>
		  	...
		  	<p class="pad10 font12">1.绑定银行卡前请先进行实名认证，请务必认真填写真实资料 </br>2.一个身份证只能绑定一个账号 </br>3.如遇问题，请<a href="tel:<?php echo $phone; ?>" target="_blank">联系客服</a></p>
