<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\www\feichangcelue/application/index\view\index\mobile\forgot_pass.html";i:1528443881;}*/ ?>
<!doctype html>
<html>
	<head>
		<meta charset="UTF-8">
...
<!--找回密码-->
	<body class="forgot_body reg_body">
		...
		<div class="mui-content">
		    <form class="forgot_form reg_form login_form mui-input-group" action="<?php echo url('index/index/updateNewPwd'); ?>" method="post">
			    ...
			    <div class="mobilenoCode_row mui-input-row">
			        ...
			        <a id="mobileno_code_a" onclick="yzm()" href="javascript:void(0);">获取验证码</a>
			    </div>
			    <div class="mui-input-row">
