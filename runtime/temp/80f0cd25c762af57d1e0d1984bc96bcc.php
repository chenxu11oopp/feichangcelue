<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"E:\phpStudy\PHPTutorial\WWW\feichangmoulue/application/index\view\index\mobile\index.html";i:1527837751;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
	<header id="header" class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title" style="right: 75px;left: 75px;">非常谋略</h1>
