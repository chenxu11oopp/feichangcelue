<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"E:\phpStudy\PHPTutorial\WWW\feichangmoulue/application/index\view\index\guild.html";i:1527837836;s:81:"E:\phpStudy\PHPTutorial\WWW\feichangmoulue/application/index\view\public\top.html";i:1527760386;s:84:"E:\phpStudy\PHPTutorial\WWW\feichangmoulue/application/index\view\public\footer.html";i:1527820766;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="w1024 br-clearfix">
            ...
            <div class="h_botR br-fr">
                <ul class="br-clearfix" id="menu-ul">
                    <li class="br-fl"><a href="./index/index.html" class="active">首页</a></li>
...
<section class="guide-section">
    ...
    <section class="guide-section-1">
        <div class="container">
            <h4 class="guide-title">01.了解<strong>非常谋略</strong>投资</h4>
            <div class="guide-section_img">
            	<p class="section1_p p_top">提供交易保障金</p>
            	<p class="section1_p p_top">提供违约保障金</p>
            	<p class="section1_p ">第三方合作平台</p>
            	<p class="section1_p ">谋略指令</p>
            	<p class="section1_p ">匹配投资人</p>
            	<p class="section1_p ">提供买卖谋略</p>
            	<p class="section1_p ">我的平台</p>
            	<p class="section1_p ">执行买卖谋略</p>
            </div>
        </div>
    </section>
        ...
        <div class="container">
                <div class="info-inner-box br-clearfix ">
                    <div class="info">
                        ...
                        <p class="info-detail">●&nbsp;选择谋略资金</p>
                        <p class="info-detail">●&nbsp;选择止盈止损</p>
                        <p class="info-detail">●&nbsp;确认发起谋略</p>
                    </div>
        ...
        <div class="container">
                <div class="info-inner-box br-clearfix ">
                    ...
                    <div class="info">
                        ...
                        <p class="info-detail info-detail-gap">●&nbsp;点买人获得90%的交易盈利,系统自动划入点买人的非常谋略账户。</p>
    ...
    <section class="guide-section-6 guide-section-4">
        <div class="container">
        	<div class="info-inner-box br-clearfix ">
                    <div class="info">
                        <h4 class="guide-title">06.<strong>急速</strong>提现</h4>
                        <p class="info-detail">●&nbsp;30分钟极速提现</p>
                    </div>
    ...
    <div class="footer_bot">
        <div class="w1024 br-clearfix">
            <div class="bot_l br-fl">
                <p>浙江省杭州市上城区外海西湖国贸21层<br>全国统一服务热线 ：<?php echo $phone; ?><br>客服服务时间工作日：9:00-18:00</p></div>
